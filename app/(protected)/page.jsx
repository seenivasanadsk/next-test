  ...
  return (
    <div className="h-full flex justify-center items-center text-gray-900 dark:text-gray-100 p-6">
      <main className="bg-white dark:bg-amber-1200 shadow-xl max-w-6xl w-full h-full rounded-xl overflow-hidden flex flex-col text-lg">
        {/* Header */}
        <header className="bg-amber-100 dark:bg-amber-1000 text-amber-900 dark:text-amber-50 p-5 border-b border-amber-200 dark:border-amber-950 flex flex-col md:flex-row gap-5">
          ...
          <div className="flex-1 self-center flex gap-2 justify-end">
            <button className="px-2 py-1 rounded-md cursor-pointer bg-blue-500 dark:bg-blue-800 text-white shadow hover:bg-blue-600">
              Options
            </button>
            <button
              className="px-2 py-1 rounded-md cursor-pointer bg-green-500 dark:bg-green-800 text-white shadow hover:bg-green-600"
        ...
        <div className="flex-1 p-6 overflow-hidden">
          <div className="h-full border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm overflow-hidden flex flex-col">
            ...
            {/* <div className="p-4 text-center text-gray-500 dark:text-gray-400 border-t border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-amber-1200">
              No data Found.
            </div> */}
          </div>
        </div>
        ...
        {/* Footer */}
        <footer className="bg-amber-100 dark:bg-amber-1000 text-amber-900 dark:text-amber-50 p-4 border-t border-amber-200 dark:border-amber-950 flex justify-between items-center flex-col md:flex-row gap-4">
          <div className="flex gap-x-4">
            <button className="text-center px-3 py-1.5 rounded-md cursor-pointer bg-cyan-500 hover:bg-cyan-600 text-white shadow">
              Opened Tokens
            </button>
            <button className="text-center px-3 py-1.5 rounded-md cursor-pointer bg-cyan-500 hover:bg-cyan-600 text-white shadow">
              Closed Tokens
