...
export const HTTP_STATUS = {
    // 1xx Informational
    100: { name: "Continue", description: "Request received, client should continue" },
    101: { name: "Switching Protocols", description: "Protocol is switching as requested" },
    102: { name: "Processing", description: "WebDAV, request received but not completed" },
    ...
    203: { name: "Non-Authoritative Information", description: "Response from third-party source" },
    ...
    307: { name: "Temporary Redirect", description: "Temporary redirect, method preserved" },
    308: { name: "Permanent Redirect", description: "Permanent redirect, method preserved" },

    // 4xx Client Errors
    400: { name: "Bad Request", description: "Invalid request syntax" },
    401: { name: "Unauthorized", description: "Authentication required or failed" },
    ...
    406: { name: "Not Acceptable", description: "Content not acceptable per headers" },
    407: { name: "Proxy Authentication Required", description: "Proxy requires auth" },
    ...
    411: { name: "Length Required", description: "Content-Length header required" },
    412: { name: "Precondition Failed", description: "Conditional request failed" },
    413: { name: "Payload Too Large", description: "Request body too large" },
    414: { name: "URI Too Long", description: "Request URI too long" },
    415: { name: "Unsupported Media Type", description: "Request media type not supported" },
    416: { name: "Range Not Satisfiable", description: "Requested range not valid" },
    417: { name: "Expectation Failed", description: "Expect header failed" },
    418: { name: "I'm a teapot", description: "RFC 2324, joke status" },
    422: { name: "Unprocessable Entity", description: "WebDAV, validation error" },
    425: { name: "Too Early", description: "Retry later, avoiding replay attacks" },
    426: { name: "Upgrade Required", description: "Client must switch protocol" },
    428: { name: "Precondition Required", description: "Require conditional request" },
    429: { name: "Too Many Requests", description: "Rate limiting" },
    431: { name: "Request Header Fields Too Large", description: "Headers too large" },
    451: { name: "Unavailable For Legal Reasons", description: "Legal restrictions" },
    ...
    503: { name: "Service Unavailable", description: "Server overloaded or down" },
    504: { name: "Gateway Timeout", description: "Upstream server timeout" },
    505: { name: "HTTP Version Not Supported", description: "Version unsupported" },
    506: { name: "Variant Also Negotiates", description: "Transparent content negotiation" },
    507: { name: "Insufficient Storage", description: "WebDAV, server storage full" },
    508: { name: "Loop Detected", description: "WebDAV, infinite loop detected" },
    510: { name: "Not Extended", description: "Further extensions required" },
    511: { name: "Network Authentication Required", description: "Requires network authentication" },
};
